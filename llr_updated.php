<?php   
				...
				if(isset($_GET['submit'])){
					...
					$sql="select llr_id,llr_status from llr where dscn='$aad' and llr_id='$llr_id'";
					...
					if (mysqli_num_rows($result) > 0) {
						if($row2[1]==0){
							...
							$sql1="update llr set llr_status=$llr_status,llr_issue_date='$date' where dscn='$aad' and llr_id='$llr_id'";
