...
<body>
<p><h1><b>Registration Table</b></h1></p>
...
$sql1 = "SELECT dscn,name,cov,r_id,reg_status,mail_id FROM reg";
...
'<a href="mailto:'.$row['mail_id'].'?subject='.$subject.'&body='.$body.'">'.$row['mail_id'].'</a>'. '</td><td align="left">' .'<a href="updatestatus.php?id='.$row['r_id'].'">'.'Update Status'.'</a>'.'</td><td align="left"></td></tr></div>';
//echo '</tr>';
}
