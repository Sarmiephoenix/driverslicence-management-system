...
$sql1 = "SELECT dscn,name,cov,dl_id,dl_status,mail_id FROM dl";
...
'<a href="mailto:'.$row['mail_id'].'?subject='.$subject.'&body='.$body.'">'.$row['mail_id'].'</a>'.'</td><td align="left">' .'<a href="updatedlstatus.php?id='.$row['dl_id'].'">'.'Update Status'.'</a>'.'</td><td align="left"></td></tr></div>';
//echo '</tr>';
}
