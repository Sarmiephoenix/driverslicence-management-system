...
<body>
<p><h1><b><u>Registration Table</u></b></h1></p>
...
$sql1 = "SELECT dscn,name,cov,vno,reg_issue_date,reg_expiry_date,mail_id FROM reg where DATEDIFF(reg_expiry_date,CURDATE())<=30";
...
$body='Hello,'.'Your Registration for vehicle with No '.$row['vno'].' will expire within a month. '.'Please visit nearest Office to renew registration of your vehicle '.' - DLRS';
$link=$row['mail_id'];
