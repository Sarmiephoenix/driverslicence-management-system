...
<body>
    ...
    <div class="student-w3ls">
      <div class="container">
          ...
          <div class="col-md-8 student-grid">
			<?php
				...
				$results1=0;
					...
					$aad=$_GET["aad"];
					$passwd = $_GET["passwd"];
					$sql = "SELECT first_name,middle_name,last_name,dob FROM citizen where dscn=$aad";

					$sql1 = "SELECT dscn,reg_status,passwd FROM reg where dscn=$aad";
					...
					if (mysqli_num_rows($result) > 0) {
						...
						while($row = mysqli_fetch_assoc($result)) {
							echo "<p><br><br><br>";
							echo "<p><b>&emsp; &emsp; Dsc number: " . $aad . "<br>";
		...
		<p align="center"><a href="click_registration.php"><h2 align="center">Exit</h2></a></p>
		</body>
		</html>