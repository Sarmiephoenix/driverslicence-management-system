...
<script> function otp()
          {
            window.alert("Complaint filed successfully");
          }
</script>
<!--js-->
<!--webfonts-->
      ...
      <div class="container">
        ...
        <div class="student-grids">
          <div class="col-md-6 student-grid">
			<form  method="post">
				<br><br><br>
				&emsp;&emsp;&emsp;DSC number: <input type="text" name="aad" ><br><br>
...
<?php
					...
					if(isset($_POST['submit']))
					{
						...
						$date = date('Y-m-d');
						echo $date;
						$sql="INSERT INTO complaint(dscn,cdate,cdesc) VALUES('$q1','$date','$com')";
