				...
				<!---Brand and toggle get grouped for better mobile display--->
						<div class="navbar-header">
							...
							<div class="navbar-brand">
								<h1><a href="index.php"> <span>Driver Licence Registration System</span></a></h1>
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="student-grids">
						<div class="col-md-6 student-grid">
							<h4>Enter your Driving School Certificate Number</h4>
								<p><form action="reg.php" method="get">
          				<br><br><br>
          				DSC number: <input type="text" name="aad" >
						<br><br>
						Token : <input type="password" name="passwd">
						<br><br>
