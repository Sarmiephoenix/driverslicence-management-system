<?php   
				...
				if(isset($_GET['submit'])){
					...
					$vno = $_GET["vno"];
					$sql="select r_id,reg_status from reg where dscn='$aad' and r_id='$r_id'";
					...
					if (mysqli_num_rows($result) > 0) {
						if($row4[1]==0){
							...
							$sql1="update reg set reg_status=$reg_status,reg_issue_date='$date',vno='$vno',reg_expiry_date='$exp'              where dscn='$aad' and r_id='$r_id'";
