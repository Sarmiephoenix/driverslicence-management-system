...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO llr(dscn,name,cov,edate,eid,epwd,passwd,mail_id) VALUES('$aad','$name','$q1','$d','$eid','$pwd','$passwd','$mail_id')";
...
<tr>
 <td colspan="2">
  ...
  <li>Bring card,2 passport size photographs</br>DOB proof and Address Proof</li>
  </ul>
 </td>
</tr>
</table>
