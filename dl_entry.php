...
mysqli_select_db($conn,"dbms_p1");
					...
					$sql1="select llr_issue_date,llr_status,llr_id,cov from llr where dscn=$aad order by llr_id desc" ;
					$result1=$conn->query($sql1);

					$sql5="select first_name,middle_name,last_name,mail_id from citizen where dscn=$aad";
					...
					else
					{
						...
						$sql2 = "select city from address where dscn='$aad'";
						...
						$sql="INSERT INTO dl(dscn,name,cov,edate,eid,passwd,mail_id) VALUES('$aad','$name','$q1','$d','$eid','$passwd','$mail_id')";
...
<tr>
 <td colspan="2">
  ...
  <li>Bring Certificate card,2 passport size photographs</br>DOB proof and Address Proof</li>
  </ul>
 </td>
</tr>
</table>
