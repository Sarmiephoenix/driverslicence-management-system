...
if(isset($_POST['submit']))
{
	...
	$sql="INSERT INTO reg(dscn,name,cov,model,company,rdate,passwd,mail_id) VALUES('$aad','$name','$q1','$model','$company','$d','$passwd','$mail_id')";
...
<td> <?php echo "  ".$rto_address ?>FRSC hq</td>
</tr>
...
<tr>
 <td colspan="2">
  ...
  Bring card,2 passport size photographs</br>DOB proof and Address Proof,and vehicle to be registered</br>
  </p>
 </td>
</tr>
</table>
