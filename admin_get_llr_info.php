...
$sql1 = "SELECT dscn,name,cov,llr_id,llr_status,mail_id FROM llr";
...
'<a href="mailto:'.$row['mail_id'].'?subject='.$subject.'&body='.$body.'">'.$row['mail_id'].'</a>'.'</td><td align="left">' .'<a href="updatellrstatus.php?id='.$row['llr_id'].'">'.'Update Status'.'</a>'.'</td><td align="left"></td></tr></div>';
//echo '</tr>';
}
