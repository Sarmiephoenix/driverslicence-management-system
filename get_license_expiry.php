...
<body>
<p><h1><b><u>License Holders</u></b></h1></p>
...
$sql1 = "SELECT dscn,name,license_no,cov,license_issue_date,license_expiry_date,mail_id FROM license where DATEDIFF(license_expiry_date,CURDATE())<=30";
...
$body='Hello,'.'Your Driver\'s License with DL No '.$row['license_no'].' will expire within a month. '.'Please visit the nearest Office to renew your license. '.' - DLRS';
$link=$row['mail_id'];
echo '<div align="center"><tr><td align="left">' . 
$row['dscn'] . '</td><td align="left">' . 
