...
$sql1 = "select gender,first_name,middle_name,last_name from citizen where dscn='$aad'";
...
$sql2 = "select street,city,state from address where dscn='$aad'";
$result2 = $conn->query($sql2);
$row2 = mysqli_fetch_row($result2);
$address = $row2[0].", ".$row2[1].", ".$row2[2];
//echo $address;

$sql3 = "select llr_issue_date,cov from llr where dscn='$aad' order by llr_id desc limit 1";
